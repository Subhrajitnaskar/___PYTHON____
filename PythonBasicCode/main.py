...
# v = 34j complex type j tai likhte hobr imajenari value jonno

# print(type(v))



# st = '1231243235 dsagaiogiaeb !@#$%^&*' string type

# print(type(st))

# b = True

# t = False buolean type
...
# print(f"my name is {name} and my age is {age}") // formating string
...
# print(b - a)
# print(a * b)
# print(b//a) // exact value te convert kore kono point ane na
# print(b/a)
# print(5**100) // powe theke to to the power
# print(32%5) // sudhu remender provide hobe
